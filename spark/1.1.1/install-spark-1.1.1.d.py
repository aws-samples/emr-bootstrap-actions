...
def download_and_uncompress_files():
	...
	subprocess.check_call(["/bin/ln","-s",hadoop_apps+"/spark-" + spark_version +".c", spark_home])
	print "Spark v1.1.1.d uses the same binaries as v.1.1.1.c, delta is in the installation script"
	# cleanup 
